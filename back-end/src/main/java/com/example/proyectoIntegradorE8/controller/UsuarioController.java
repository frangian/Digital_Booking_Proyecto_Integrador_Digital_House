   ...
   private final UsuarioService usuarioService;
    ...
    public ResponseEntity<?> actualizarUsuario(@RequestBody @NotNull Usuario usuario){
        try {
            ...
            Usuario usuarioExistente = usuarioService.buscarUsuario(usuario.getId());
            usuarioService.actualizarUsuario(usuarioExistente);
            log.info("actualizarUsuario: usuario con id: "+usuarioExistente.getId()+" actualizado en la BBDD exitosamente");
