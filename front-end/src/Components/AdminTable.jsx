            ...
            if (result.isConfirmed) {
                ...
                .then(res => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops',
                        text: 'Lamentablemente no ha podido ieliminar el prdoucto. Por favor intente más tarde',
                        confirmButtonColor: "#1dbeb4"
                    })
                })
            }
                    ...
                    productos?.map(producto => (
                        <div className="tabla-celda" key={producto.id}>
                            ...
                            <div className="editar-borrar">
                                <FontAwesomeIcon icon={faPenToSquare} style={{color: "#005eff", fontSize: "1.2rem", cursor: "pointer"}} />
                            </div>
                            <div className="editar-borrar">
                                <FontAwesomeIcon 
                                icon={faTrashCan} 
